export default {
  ...
  'pages.setting.translateZhWayTooltip':'开启后，会将describe、shorten等结果转中文',
  'pages.setting.baiduTranslate':'百度翻译',
  'pages.setting.openai': 'GPT 翻译',
  'pages.setting.deepl': 'Deepl 翻译',
  'pages.setting.ngDiscord': '反代配置',
  'pages.setting.ngDiscordTooltip': 'cdn配置，配置后可以解决国内用户图片无法加载的问题',
  'pages.setting.adminImagePrefix': '管理页图片前缀',
  'pages.setting.adminImagePrefixTooltip': 'admin管理页图片前缀，可设置`https://wsrv.nl/?url=`反代discord图片',
  'pages.setting.save':'保存',
  'pages.setting.saveSuccess':'保存成功',
  'pages.setting.saveFailed':'保存失败',
  'pages.setting.cdnRefreshed':'URL刷新接口',
  'pages.setting.cdnRefreshedTooltip':'开启后，可通过接口刷新cdn链接',
  'pages.setting.notifyHook':'回调地址',
  'pages.setting.notifyHookTooltip':'全局回调地址，接口没有配置时默认使用这个',
  ...
  'pages.setting.accountSyncCron':'账号信息同步',
  'pages.setting.accountSyncCronTooltip':'discord账号信息同步cron表达式，每天20:30执行一次，设置为0关闭此定时任务',
  'pages.setting.redis':'Redis配置',
  'pages.setting.datasource':'MySQL配置',
  'pages.setting.datasourceTooltip':'只需要创建数据库，表结构会自动创建',
};
